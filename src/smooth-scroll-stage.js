...
document.addEventListener("DOMContentLoaded", (event) => {
    ...
    function setScrollTriggers(){
      ...
      // descriptinの高さ
        ...
        let descriptionWrapperHeight = descriptionWrapper.scrollHeight - descriptionWrapper.clientHeight || 0;

        let description01 = document.querySelector('.section_description--01');
        let description01Height = description01.scrollHeight - description01.clientHeight || 0;

        let description02 = document.querySelector('.section_description--02');
        let description02Height = description02.scrollHeight - description02.clientHeight || 0;

        let description03 = document.querySelector('.section_description--03');
        let description03Height = description03.scrollHeight - description03.clientHeight || 0;

        let description04 = document.querySelector('.section_description--04');
        let description04Height = description04.scrollHeight - description04.clientHeight || 0;

        let description05 = document.querySelector('.section_description--05');
        let description05Height = description05.scrollHeight - description05.clientHeight || 0;


      // section_wrapperのheightを指定
        const sectionWrapper = document.querySelector('.section__wrapper');
      let sectionWrapperHeight = descriptionWrapperHeight + description01Height + description02Height + description03Height + description04Height + description05Height + window.innerHeight * 2;
      ...
      .fromTo('.section_description--01',{
        ...
        let animation02 = ScrollTrigger.create({
          ...
          end: `+=${description01Height}px top`,
          scrub: true,
          markers: true,
          onLeave: ()=>{
            gsap.timeline()
      ...
      tl02.to('.section_description--01', {
        ...
        let animation03 = ScrollTrigger.create({
          ...
          end: `+=${description01.clientHeight}px`,
          scrub: true,
          markers: true,
          onEnter: ()=>{
            gsap.timeline()
        ...
        let animation05 = ScrollTrigger.create({
          ...
          end: `+=${description02.clientHeight}px`,
          scrub: true,
          markers: true,
          onEnter: ()=>{
            gsap.timeline()
        ...
        let animation07 = ScrollTrigger.create({
          ...
          end: `+=${description03.clientHeight}px`,
          scrub: true,
          markers: true,
          onEnter: ()=>{
            gsap.timeline()
        ...
        let animation09 = ScrollTrigger.create({
          ...
          end: `+=${description04.clientHeight}px`,
          scrub: true,
          markers: true,
          onEnter: ()=>{
            gsap.timeline()
        ...
        let animation11 = ScrollTrigger.create({
          ...
          end: `+=${description05.clientHeight}px`,
          scrub: true,
          markers: true
        })
